...
<a href="<?php echo URL; ?>/pelanggan/input" class="btn"><i class="fa-solid fa-folder-plus"></i> Input Pelanggan</a>
      ...
      <tbody>
            ...
            foreach ($data['rows'] as $row) { ?>
                  <tr>
                        ...
                        <td><a href="<?php echo URL; ?>/pelanggan/delete/<?php echo $row['pel_id']; ?>" class="btn" onclick="return confirm('Are you sure?')"><i class="fa-regular fa-trash-can"></i></a></td>
                  </tr>
            <?php $no++;
            } ?>
      </tbody>
