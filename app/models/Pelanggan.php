...
class Pelanggan extends Model
{
     ...
     public function show()
     {
          ...
          ON p.pel_id_gol=g.gol_id 
          INNER JOIN tb_users u
          ON p.pel_id_user=u.user_id ORDER BY pel_id";
     ...
     public function update()
     {
          ...
          $sql = "UPDATE tb_pelanggan
                  SET pel_id_gol=:pel_id_gol, pel_no=:pel_no, pel_nama=:pel_nama, pel_alamat=:pel_alamat, pel_hp=:pel_hp, pel_ktp=:pel_ktp, 
               pel_seri=:pel_seri, pel_meteran=:pel_meteran, pel_aktif=:pel_aktif, pel_id_user=:pel_id_user, updated_at=:updated_at
                  WHERE pel_id=:pel_id";
